        ...
        <div className='contact_content'>
          ...
          <div className='contact_info'>
            ...
            <div className='contact_card'>
              ...
              <span className='contact_card-data'>8825646069</span>
            </div>
            ...
            <div className='contact_card'>
              ...
              <span className='contact_card-data'>gowthamDev</span>
            </div>
          </div>
        </div>
        <div className='contact_content'>
          <h3 className='contact_title'>Send a Message</h3>
          ...
          <form ref={form} onSubmit={sendEmail} className='contact_form'>
            ...
            <div className='contact_form-div contact_form-area'>
              <label className='contact_form-tag'>Tell us Something!!</label>
              <textarea
                name='feedback'
                cols='30'
                rows='10'
